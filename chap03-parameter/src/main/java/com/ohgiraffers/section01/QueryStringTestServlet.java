...
public class QueryStringTestServlet extends HttpServlet {
    ...
    * httpServlet를 상속받아 오버라이딩한 현태 클래스의 doGet() method 가 동적 바인딩에 의해 호출된다
    * ======================================
    ...
    * 화면에서 전달한 form내의 모든 input 태그의 값들을 hashMap으로 관리하고 있으므로,
    * 원하는 값을 찾기 위해서는 key역할을 하는 문자열이 필요하기 때문이다.*/
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Date birthDay = java.sql.Date.valueOf(req.getParameter("brithday"));
